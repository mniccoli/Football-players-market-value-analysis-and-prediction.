...
smote = SMOTE(random_state=42)  # minority class oversampling
X_resampled, y_resampled = smote.fit_resample(defenders, y_def)
...
hist_def = classificator.fit(X_train, y_train, epochs=100, verbose=1, validation_data=(X_test, y_test),
                             callbacks=[callback])
