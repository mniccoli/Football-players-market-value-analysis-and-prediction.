...
midfielders.pop('marketValue') #to avoid dropping of ln_mktval
...
y_mid = midfielders.pop('ln_mktval')

# dataframe split
X_train, X_test, y_train, y_test = train_test_split(midfielders, y_mid, test_size=0.2, random_state=42)
sc = StandardScaler()
...
results.to_excel('mid_predANN.xlsx')

# plt.plot(y_test, y_pred, '.', markersize=12)
# plt.title('Actual vs Predicted Midfielders Scatter Plot - Log Scale', fontsize=15)
